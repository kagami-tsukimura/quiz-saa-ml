...
if col_check.button("チェック"):
    ...
    st.write(
        """
            ...
            ・選択肢Bは不適切です。  
            Amazon Comprehendで音声記録をテキストに変換することはできません。  
            また、Amazon Lexでテキスト内容の感情分析を実施できません。  
            Amazon LexはAlexaに利用されている音声言語対話AIサービスです。\n
            ・選択肢Cは不適切です。  
            Amazon Comprehendで音声記録をテキストに変換することはできません。  
            また、Amazon Pollyでテキストに対して感情分析を実施することはできません。  
            Amazon Pollyは人間の声のような音声を合成する音声生成AIサービスです。\n
            ・選択肢Dは不適切です。  
            Amazon Pollyでテキストに対して感情分析を実施することはできません。  
        """
    )
